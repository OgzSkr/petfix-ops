...
import { HZLMRKTOPS_ORDER_PROFIT_REPORT } from '../../hzlmrktops/constants.js';
...
export function renderOpsReportsPage({ authRequired = true, auth = null } = {}) {
  ...
  const bodyHtml = `
    <div class="ops-analytics-page ops-reports-page ops-compact-page pf-unified-page">
      ...
      <section class="ops-panel ops-panel--profit-link">
        <a class="ops-report-nav-card" href="${HZLMRKTOPS_ORDER_PROFIT_REPORT}">
          <div class="ops-report-nav-card-copy">
            <h3>Sipariş Kârlılık Raporu</h3>
            <p>Kayıtlı siparişlerin tutar, maliyet ve kâr dökümü. En fazla 30 günlük dönem; tarih ve durum filtresi.</p>
          </div>
          <span class="ops-report-nav-card-arrow" aria-hidden="true">→</span>
        </a>
      </section>
    </div>`;
