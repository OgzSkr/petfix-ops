...
export function renderOpsIntegrationsPage({ authRequired = true, auth = null } = {}) {
  ...
  const bodyHtml = `
    <div class="ops-integrations-page pf-unified-page">
      <div class="ops-int-hero" id="integrationsHero">
        <div class="ops-int-hero-copy">
          <p class="ops-analytics-eyebrow">Operasyon · Kanallar</p>
          <h1 class="ops-int-title">Mağaza bağlantıları</h1>
          <p class="ops-int-lead">Getir, Yemeksepeti ve Trendyol Go mağazalarınızı bağlayın, sipariş alımını yönetin ve kurulum adımlarını takip edin.</p>
          <div class="ops-info-stack ops-info-stack--compact">${infoBlocks}</div>
        </div>
        <div class="ops-int-stats">
          <div class="ops-int-stat">
            <span class="ops-int-stat-value" id="intStatTotal">—</span>
            <span class="ops-int-stat-label">Toplam kanal</span>
          </div>
          <div class="ops-int-stat">
            <span class="ops-int-stat-value" id="intStatConnected">—</span>
            <span class="ops-int-stat-label">Bağlı mağaza</span>
          </div>
          <div class="ops-int-stat ops-int-stat--warn">
            <span class="ops-int-stat-value ops-int-stat-value--sm" id="intStatAttention">—</span>
            <span class="ops-int-stat-label">Dikkat gereken</span>
          </div>
        </div>
      </div>

      <section id="listView" class="ops-view">
        <section class="ops-panel ops-int-panel">
          <header class="ops-panel-head">
            <div>
              <h3>Bağlı kanallar</h3>
              <p class="ops-panel-sub">Duruma tıklayarak kurulum ve API ayarlarını düzenleyin</p>
            </div>
          </header>
