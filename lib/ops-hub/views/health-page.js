...
export function renderOpsHealthPage({ authRequired = true, auth = null, focus = null } = {}) {
  const bodyHtml = `
    ...
    <p class="ops-meta" style="margin-bottom:16px">Kanal bağlantılarının, stok uyumunun ve altyapının genel özeti.</p>
    ...
    <section class="ops-section">
      <h3>Stok uyumu</h3>
      <p class="ops-meta">BenimPOS master stok ile kanal stoklarının karşılaştırması.</p>
    ...
    <details class="ops-section ops-collapsible">
