...
export function renderOpsPickingPage({ authRequired = true, auth = null } = {}) {
  ...
  const bodyHtml = `
    <div class="ops-picking-page ops-compact-page pf-unified-page">
      <section id="listView" class="ops-view">
        <section class="ops-panel ops-compact-page-panel">
          ${bar}
          <p class="ops-order-profit-note">Yeni sipariş geldiğinde kuyruk otomatik yenilenir.</p>
          <div id="queueList" class="ops-card-grid ops-picking-queue"></div>
      ...
      <div class="ops-detail-grid">
        <div class="ops-scan-panel">
          <div id="matchingBanner" class="ops-alert ops-alert--warn hidden" role="alert">
            ...
            <a href="/hzlmrktops/urunler" class="ops-btn ops-btn-secondary" style="display:inline-flex;text-decoration:none">Ürünler</a>
          </div>
