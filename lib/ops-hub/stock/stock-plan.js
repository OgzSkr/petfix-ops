...
import { isMasterAutoStockEnabled } from '../../product-matching/auto-stock-sync.js';
...
export function buildStockSyncPlan(db, opsChannel, options = {}) {
  ...
  for (const mapping of pm.mappings) {
    ...
    if (options.autoStockEligibleOnly && !isMasterAutoStockEnabled(master)) {
      skipped.autoStockDisabled += 1;
      continue;
    }
    ...
    if (channelProduct.getirActive === false && pushMode !== 'price') {
      skipped.inactiveChannelProduct += 1;
      continue;
    }
