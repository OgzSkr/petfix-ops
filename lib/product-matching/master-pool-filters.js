...
export function summarizeMasterMatchAggregate(channelMappings = {}, duplicateAnalysis = null) {
  if (duplicateAnalysis?.hasDuplicates) {
    const extra = duplicateAnalysis.extraMappingCount || 0;
    return {
      code: 'duplicate_mapping',
      label: extra === 1 ? 'Çift eşleşme var' : `${extra + 1} eşleşme — fazla bağlantı`
    };
  }
