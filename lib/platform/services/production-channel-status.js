...
const CHANNEL_DEFS = [
  ...
  { id: 'getir', label: 'Getir', opsChannel: 'getir', envKeys: ['GETIR_API_KEY'] },
  { id: 'uber-eats', label: 'Uber / Trendyol GO', opsChannel: 'trendyol_go', envKeys: ['UBER_EATS_API_KEY', 'UBER_EATS_API_SECRET'] },
  { id: 'trendyol-marketplace', label: 'Trendyol Pazaryeri', opsChannel: null, envKeys: ['TRENDYOL_API_KEY'] },
  { id: 'woocommerce', label: 'WooCommerce', opsChannel: null, envKeys: ['WOOCOMMERCE_URL', 'WOOCOMMERCE_CONSUMER_KEY'] }
];
