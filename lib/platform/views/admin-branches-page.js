...
export function renderAdminBranchesPage({ authRequired = true, auth = null } = {}) {
  ...
  const bodyHtml = `
    <div class="ops-branches-page pf-unified-page">
      <div class="ops-admin-hero">
        <div class="ops-admin-hero-copy">
          <p class="ops-analytics-eyebrow">Yönetim · Şubeler</p>
          <h1 class="ops-admin-title">Şube yönetimi</h1>
          <p class="ops-admin-lead">Tenant altındaki depo ve mağaza şubelerini yönetin. Her şubenin kendi kanal kimlik bilgileri ve RBAC yetkileri vardır.</p>
          <div class="ops-info-stack">${infoBlocks}</div>
        </div>
        <div class="ops-admin-stats">
          <div class="ops-admin-stat">
            <span class="ops-admin-stat-value" id="branchStatTotal">—</span>
            <span class="ops-admin-stat-label">Toplam şube</span>
          </div>
          <div class="ops-admin-stat">
            <span class="ops-admin-stat-value" id="branchStatActive">—</span>
            <span class="ops-admin-stat-label">Aktif şube</span>
          </div>
          <div class="ops-admin-stat ops-admin-stat--muted">
            <span class="ops-admin-stat-value ops-admin-stat-value--sm" id="branchStatGrants">—</span>
            <span class="ops-admin-stat-label">RBAC grant</span>
          </div>
        </div>
      </div>
