...
import { isEcommerceChannel, isHzlmrktopsBuyboxChannel, HZLMRKTOPS_BUYBOX_CHANNEL_IDS } from '../../hzlmrktops/constants.js';
...
export function renderChannelOrdersPage({ channelId, auth, productMatchingMode = 'legacy' }) {
  ...
  return wrapPanelPage({
    ...
    scripts: ['/assets/channel-page.js?v=3', '/assets/orders.js?v=32']
  });
}
...
export function renderHzlMrktOpsProfitPage({ auth, productMatchingMode = 'legacy' }) {
  ...
  const innerHtml = `
      <div class="orders-wrap pf-ops-orders">
        <section class="panel channel-orders-intro">
          ...
          <nav class="orders-subnav" id="hzlmrktopsChannelFilters" role="tablist" aria-label="Kanal filtresi">
  ...
  return wrapPanelPage({
    ...
    bodyHtml: innerHtml,
    stylesheets: ['/assets/styles.css?v=corp2', '/assets/orders.css?v=25'],
    scripts: ['/assets/channel-logos.js?v=2', '/assets/orders.js?v=32']
  });
}
