  ...
  function renderBenimposProductsPage() {
        ...
        <div class="bp-shell">
          <div class="bp-topbar">
            ...
            <div class="bp-top-actions">
              ...
              <button type="button" class="bp-btn" id="bpLinkGetirBarcodeBtn">Getir Barkod Eşleştir</button>
            </div>
          </div>
    ...
    return renderPetfixShell({
      ...
      stylesheets: [
        ...
        '/assets/benimpos-products.css?v=10'
      ],
      scripts: [
        '/assets/channel-logos.js?v=2',
        '/assets/benimpos-products.js?v=18'
      ]
    });
  }
