...
export function createPlatformPages(auth, runtimeConfig = {}) {
  ...
  function renderBenimposProductsPage() {
    ...
    const innerHtml = `
        <div class="bp-shell">
          <div class="bp-topbar">
            <div>
              <h1>Ürünler</h1>
              <p class="bp-topbar-lead">BenimPOS ürün listenizi kanallardaki menülerle eşleştirin. Fiyat ve stok değişiklikleri kanallara yalnızca siz onayladığınızda gönderilir.</p>
            </div>
          ...
          <section class="bp-table-card">
            <div class="bp-table-scroll">
              <table class="bp-table">
                ...
                <tbody id="bpBody">
                  <tr><td colspan="8" class="bp-loading">Yükleniyor…</td></tr>
                </tbody>
              </table>
            </div>
    ...
    return renderPetfixShell({
      ...
      activeItem,
      auth,
      bodyHtml: `${renderPageGuideBlock(activeItem)}${innerHtml}`,
      ...
      stylesheets: [
        ...
        '/assets/benimpos-products.css?v=19'
      ],
      scripts: [
        '/assets/channel-logos.js?v=2',
        '/assets/benimpos-products.js?v=32'
      ]
    });
  }
