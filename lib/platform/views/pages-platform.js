  ...
  function renderBenimposProductsPage() {
        ...
        <div class="bp-shell">
          <div class="bp-topbar">
            <div>
              ...
              <p class="bp-topbar-lead">BenimPOS ana ürün listesi. Kanal fiyatına tıklayarak fiyat, yeşil/kırmızı noktaya tıklayarak stok gönderin. Gönderim yalnızca siz onayladığınızda çalışır.</p>
            </div>
          ...
          <nav class="bp-view-tabs" aria-label="Liste görünümü">
            ...
            <button type="button" class="bp-view-tab" data-view="orphans" id="bpViewOrphans">BenimPOS&apos;ta yok</button>
          </nav>
    ...
    return renderPetfixShell({
      ...
      stylesheets: [
        ...
        '/assets/benimpos-products.css?v=9'
      ],
      scripts: [
        '/assets/channel-logos.js?v=2',
        '/assets/benimpos-products.js?v=16'
      ]
    });
  }
